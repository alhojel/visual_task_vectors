...
def get_args():
    ...
    parser.add_argument('--option_index', default=0, type=int)
...
def evaluate(args):
    ...
    for idx in trange(len(ds)):
        ...
        for i in range(len(canvas)):
            ...
            #target_array = [[[4, b] for b in range(16)]+[[8, b] for b in range(16)]+[[10, b] for b in range(16)]+[[21, b] for b in range(16)]+[[a, b] for a in range(24,26) for b in range(8)]]        
            ...
            #decoder_ranked_neutral = [[28, 3], [24, 3], [28, 9], [26, 10], [30, 7], [27, 8], [29, 15], [25, 2], [26, 7], [30, 11], [29, 2], [25, 10], [24, 15], [30, 0], [25, 7], [27, 3], [24, 10], [25, 15], [31, 13], [29, 7], [27, 4], [26, 0], [25, 1], [31, 1], [26, 14], [30, 12], [27, 1], [27, 9], [31, 5], [27, 0], [30, 3], [25, 12], [30, 5], [30, 14], [27, 13], [25, 13], [30, 8], [24, 7], [26, 6], [28, 13], [31, 6], [25, 4], [29, 12], [31, 8], [25, 5], [31, 15], [25, 11], [28, 6], [27, 10], [28, 2], [29, 6], [30, 2], [24, 4], [31, 0], [31, 12], [25, 8], [27, 5], [28, 1], [29, 13], [31, 11], [31, 10], [25, 9], [28, 10], [28, 11], [28, 15], [28, 14], [28, 7], [26, 8], [31, 2], [28, 12], [31, 7], [27, 6], [28, 5], [27, 14], [27, 2], [28, 0], [29, 4], [24, 12], [29, 10], [29, 5], [29, 14], [29, 8], [28, 4], [31, 4], [29, 0], [27, 12], [29, 11], [24, 5], [24, 11], [31, 3], [25, 14], [26, 12], [29, 3], [24, 13], [27, 7], [26, 9], [30, 10], [24, 0], [25, 6], [31, 9], [29, 1], [27, 15], [25, 3], [27, 11], [25, 0], [31, 14], [24, 14], [30, 9], [30, 15], [28, 8], [24, 8], [30, 4], [30, 13], [30, 6], [24, 1], [26, 2], [24, 9], [24, 6], [29, 9], [26, 1], [24, 2], [30, 1], [26, 15], [26, 3], [26, 4], [26, 5], [26, 13], [26, 11]]

            #all_pairs = [[a, b] for a in range(24,32) for b in range(16)]
            #decoder_random_50 = random.sample(all_pairs, 50)
            decoder_start = 20
            decoder_end = 70


            # decoder_group = [decoder_top_30_neutral, decoder_top_40_neutral, decoder_top_30_tasks, decoder_top_40_tasks, decoder_random_50]
            decoder_group = [decoder_ranked_task[:a] for a in range(decoder_start, decoder_end,10)] #+ [decoder_ranked_neutral[:a] for a in range(decoder_start, decoder_end,10)]
            encoder_mid = [[a, b] for a in range(4,12) for b in range(16)]

10, 8], [9, 0], [20, 2], [10, 4], [21, 9], [13, 11], [7, 9], [19, 4], [10, 5], [20, 8], [8, 10], [8, 14], [16, 2], [19, 13], [16, 4], [21, 4], [12, 12], [16, 7], [15, 0], [23, 1], [18, 4], [13, 4], [15, 15], [18, 9], [8, 11], [8, 12], [16, 15], [11, 4], [22, 15], [14, 13], [20, 6], [15, 7], [20, 10], [12, 10], [17, 15], [14, 14], [18, 5], [16, 12], [6, 14], [16, 9], [5, 7], [23, 2], [6, 6], [14, 10], [9, 11], [12, 14], [17, 12], [3, 4], [22, 3], [13, 10], [14, 6], [12, 4], [0, 2], [0, 11], [18, 13], [14, 0], [16, 10], [12, 3], [23, 11], [18, 0], [14, 1], [23, 4], [19, 2], [20, 15], [12, 6], [20, 4], [15, 9], [11, 12], [15, 6], [17, 3], [16, 0], [14, 2], [15, 8], [16, 11], [12, 15], [13, 5], [5, 11], [14, 12], [17, 13], [11, 9], [12, 11], [6, 15], [21, 3], [20, 5], [18, 10], [8, 15], [17, 4], [20, 7], [17, 8], [0, 12], [19, 12], [19, 15], [21, 13], [19, 7], [20, 0], [15, 10], [17, 1], [14, 11], [14, 9], [6, 10], [15, 4], [8, 5], [22, 7], [21, 5], [5, 9], [14, 3], [12, 1], [17, 10], [17, 6], [20, 13], [16, 3], [18, 12], [0, 7], [15, 2], [18, 14], [19, 8], [18, 1], [17, 2], [15, 14], [18, 7], [5, 12], [17, 11], [19, 9], [18, 8], [16, 14], [0, 15]]
            ...
            all_pairs = [[a, b] for a in range(24) for b in range(16)]
            encoder_random_50 = random.sample(all_pairs, 50)

            encoder_start = 140
            encoder_end = 220

            encoder_group = [encoder_ranked_task[:a] for a in range(encoder_start, encoder_end,10)] #+ [encoder_ranked_neutral[:a] for a in range(encoder_start, encoder_end,10)] + [encoder_mid]

            target_array = [[encoder_group[a]+decoder_group[b]] for a in range(len(encoder_group)) for b in range(len(decoder_group))]

            encoder_labels = ["encoder_task_00"+str(a) for a in range(encoder_start, encoder_end,10)] #+ ["encoder_neutral_"+str(a) for a in range(encoder_start, encoder_end,10)] + ["encoder_mid"]
            decoder_labels = ["decoder_task_00"+str(a) for a in range(decoder_start, decoder_end,10)] #+ ["decoder_neutral_"+str(a) for a in range(decoder_start, decoder_end,10)] 
            ...
            for encoder_index, decoder_index in itertools.product(range(len(encoder_group)), range(len(decoder_group))):
                ...
                with open(os.path.join(args.output_dir, 'log.txt'), 'a') as log:
                    ...
                    current_metric["decoder_type"] = decoder_labels[decoder_index]
                    current_metric["encoder_type"] = encoder_labels[encoder_index]
            ...
            if args.output_dir and args.save_images is not None and idx % args.save_images == 0:
                ...
                plt.savefig(os.path.join(args.output_dir, f'combined_{idx}_{captions[i]}_4.png'))
                plt.show() 
